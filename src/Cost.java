...
PreparedStatement pst;
    ...
    public void jTable1(){
        try{
            String sql = "select `No`, `House_No`, `Month`, `Year`, `Purpose`, `Amount` from Cost";
    ...
    private void initComponents() {
        ...
        jComboBox4.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "2021", "2022", "2023", "2024", "2025" }));
    ...
    private void addCostActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addCostActionPerformed
        try{
            String sql = "INSERT INTO `cost`( `House_No`, `Month`, `Year`, `Purpose`, `Amount`) VALUES (?,?,?,?,?)";
            pst=conn.prepareStatement(sql);
